...
class Lockers(ModelTemplate):
    ...
    Cabinet_id=models.ForeignKey(Cabinet,on_delete=models.CASCADE,null=False)
    Pro_cate_id=models.ForeignKey(Product_category,on_delete=models.CASCADE,null=True)
